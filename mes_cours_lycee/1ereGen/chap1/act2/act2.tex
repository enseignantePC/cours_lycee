...
\begin{question}
    \questiontext{
        Répondre à l'aide du document 2 et du cours.
...
\begin{question}
    \questiontext{
        Répondre à l'aide du document 3, du cours et du tableau périodique des éléments.
    }
\end{question}
%	\answerbox{}
\subquestion{Donnez la composition du noyau de l’atome de carbone 14. Vous pouvez l'écrire sous la forme :$^{\eqnmark{nucleon}{N}}_{\eqnmark{proton}{P}}C$}
\annotate[yshift=10pt]{right,above}{nucleon}{nombre de nucleon}
\annotate[]{right,below}{proton}{nombre de protons}
\vspace{5pt}
\subquestion{
