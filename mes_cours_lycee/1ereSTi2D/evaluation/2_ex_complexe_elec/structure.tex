...
}{\Large\textbf{\evalnumber \vspace{6pt}}}{
...
{\nbpoint} % Format of the section label
{6pt} % Space between the title and label
{\centering \evaltitle } % Code before the label
...
\newcommand{\consignes}{
	\begin{center}
		\begin{tcolorbox}[
			...
			\tcbincludegraphics[height=6.5cm, size=tight, colframe=red, boxrule=1pt, arc=10pt, auto outer arc, clip upper]{logo.png}
